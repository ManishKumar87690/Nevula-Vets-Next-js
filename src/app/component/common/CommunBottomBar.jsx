...
function CommunBottomBar({ title, text, btnTitle, link, img, className }) {
  return (
    <>
      <div className="bg-[#494336] md:pt-0 pt-[60px]">
        <div className="flex gap-[28px] md:flex-row flex-col justify-center md:items-cente">
          <div className="max-w-[1181px] xl:px-12 lg:px-8 md:px-6 px-4 mx-auto">
            <div
              className={`md:max-w-[568px] flex flex-col xl:gap-10 lg:gap-6 gap-4 ${className}`}
            >
              <div>
                <Heading
                  title={title}
              ...
              <div>
                <Pera className={"!text-[#D7D9DD]"} text={text} />
              </div>
